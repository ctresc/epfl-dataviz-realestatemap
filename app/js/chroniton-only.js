...
function chroniton() {
  var margin = {top: 10, right: 20, bottom: 20, left: 20},
    ...
    brush = d3.svg.brush(),
    events = d3.dispatch('change', 'setValue', 'updateButton');
  ...
  function chart(selection) {
    ...
    selection.each(function() {
      ...
      events.on('updateButton', updateButton);
  ...
  chart.play = function() {
    if (chart.isAtEnd()) chart.setValue(domain[0]);
    play = true;
    return chart;
  };
  ...
  var timer = d3.interval(ticker, 1500);
